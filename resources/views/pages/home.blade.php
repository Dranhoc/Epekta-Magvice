...
<section class="s-hero py-0">
  ...
  <div class="s-hero__content lg:d-grid container">
    <div class="col-span-8 xl:col-span-6 xl:col-start-2 3xl:col-span-5 3xl:col-start-2">
      ...
      <h6 class="lg:w-[60%] xl:w-full">Magvice est votre partenaire IT, expert belge en solutions de parcs
        informatiques,
...
<section class="s-hero s-hero--security">
  ...
  <div class="container relative">
    <div class="s-hero--security__content scrolling-content">
      @for ($i = 0; $i < 20; $i++) <h2 class="scrolling-text">Service de protection</h2>
        ...
        <div class="swiper-wrapper">
          @for ($i = 1; $i < 5; $i++) <div class="swiper-slide">
            <figure class="slider-photos__visual">
              <img src="{{ asset('images/home/slider-photos/slider' . $i . '.jpg') }}" alt="" loading="lazy">
            </figure>
        </div>
        @endfor
        @for ($i = 1; $i < 5; $i++) <div class="swiper-slide">
  ...
  <div class="lg:d-grid container">
    <div class="col-span-10 col-start-2 text-center">
      ...
      <div class="flex justify-center gap-5">
        @for ($i = 0; $i < 5; $i++) @svg('frontoffice.icons.star') @endfor </div>

          <div class="swiper slider-testimonies">
            <div class="swiper-wrapper">

              @for ($i = 0; $i < 4; $i++) <div class="swiper-slide px-40 lg:px-150">
